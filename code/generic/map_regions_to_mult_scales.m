function [ scaled_regions, scaling_ratios ] = map_regions_to_mult_scales(region_params, regions, image_size, scales )
...
if length(scales) > 1
    ...
    expected_scale = region_params.standard_img_size * min_img_sz ./ sqrt(box_areas);
...
scaling_ratios   = (boxes_scales(:) - 1) / (min_img_sz - 1);
