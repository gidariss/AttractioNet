...
function [ bboxes ] = transform_bboxes(region_params, bboxes)
if (isfield(region_params, 'half_bbox') ...
        && ~isempty(region_params.half_bbox) ...
        && (region_params.half_bbox > 0))
    bboxes = get_half_bbox( bboxes, region_params.half_bbox );
end
end
