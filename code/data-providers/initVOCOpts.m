...
% initialize instance segmentation task paths

VOCopts.inst.clsimgpath  = [VOCopts.datadir, VOCopts.dataset, '/SBDClassSegmentation/%s.mat'];
VOCopts.inst.instimgpath = [VOCopts.datadir, VOCopts.dataset, '/SBDInstanceSegmentation/%s.mat'];
VOCopts.inst.imgsetpath  = [VOCopts.datadir, VOCopts.dataset, '/ImageSets/Main/%s.txt'];

VOCopts.inst.clsresdir   = [VOCopts.resdir, 'SBDInstance/%s_%s_cls'];
VOCopts.inst.instresdir  = [VOCopts.resdir, 'SBDInstance/%s_%s_inst'];
VOCopts.inst.clsrespath  = [VOCopts.inst.clsresdir,  '/%s.png'];
VOCopts.inst.instrespath = [VOCopts.inst.instresdir, '/%s.png'];
